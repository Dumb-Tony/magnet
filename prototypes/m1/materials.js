...
const ScrapSurfaces=(()=>{
 ...
 function infer(color,metal){if(color==='#397a89')return 'water';if(color==='#b29164'||color==='#9b815c')return 'wood';if(color==='#354b53')return metal>.5?'steel':'rubber';if(['#597d83','#5d8990','#719293','#d7e5c7'].includes(color))return 'glass';if(['#b6ad91','#a4b3ad','#bdaf93'].includes(color))return 'brick';if(['#6b8286','#3c4d53','#35474e'].includes(color))return 'asphalt';if(['#8da29a','#b19f7c','#8b9a97','#b5bdb0','#77968d','#829c92'].includes(color))return 'concrete';return metal>.55?'steel':'paint';}
